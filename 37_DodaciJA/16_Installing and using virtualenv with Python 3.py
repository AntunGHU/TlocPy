...
# Navigate to your site's directory, where you'll create the new virtual environment: # ? [server]$ cd ~/example.com
# Update your .bash_profile # ? [server]$ . ~/.bash_profile
...
# View the following article for information on how to use pip to install Python modules:  Using pip to install Python 3 modules

# * Troubleshooting
# Errors creating a virtualenv: You may see the following errors when attempting to create a virtualenv using Python 3.7.
