...
# Dinamika izrade rjesenja u Coltovoj izvedbi je zabavna. Ponesto napise pa to odmah testira (najcesce s print) pa dopise ponovo testira itd. 
# Raspored metoda i njihova kreiranja moze i varirati ali Dunderi obicno idu na vrh!!
# L2: Postoje varijante pokera sa 2 ili cak 4,5 spilova, a tada bi uz self moglo ici i "quantity"
# L5: self.card je konacno rijeseno sa LC ali Colt daje i opciju sa for-loop:
#? self.cards = []
#?     for suit in suits:
#?         for value in values:
#?         # print(Card(value, siut))
#?         self.cards.append(Card(value, suit))
#? Deck() # poziva izvodjenje i pojavu "... Q of Diamonds, K of Diamonds" po redu
# Ima jos...
