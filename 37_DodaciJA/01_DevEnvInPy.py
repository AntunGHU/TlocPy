...
# I like to use this script that asks the server to pull from the git repository and restart apache. [source](https://yuji.wordpress.com/2011/04/09/# django-python-fabric-deployment-script-and-example/)
